...
if idx_footer != -1:
    idx_sidebar = content.find("{/* Popup de gerenciamento dos Textos", idx_footer)
    if idx_sidebar != -1:
        content = content[:idx_footer] + footer_new + content[idx_sidebar:]
    else:
        print("COULD NOT FIND Popup de gerenciamento")
else:
    print("COULD NOT FIND Footer Actions")
