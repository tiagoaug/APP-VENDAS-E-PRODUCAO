      ...
      <div className="flex flex-col gap-6 py-4">
        ...
        <div className="flex p-1 bg-slate-100 dark:bg-slate-800 rounded-2xl">
           <button
             ...
             data-guide-anchor="printSoleLabel.abaToggle"
          ...
          <>
            ...
            <div className="flex gap-2">
              <button
                ...
                data-guide-anchor="printSoleLabel.estrategiaToggle"
              ...
              <div className="flex flex-wrap gap-2">
                {['30x20', '40x25', '40x30', '40x40', '50x25', '50x30', '50x40', '50x50'].map(size => (
                  <button
                    ...
                    data-guide-anchor="printSoleLabel.tamanhoEtiqueta"
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between px-1">
                ...
                <button
                  ...
                  data-guide-anchor="printSoleLabel.selecionarTudo"
                ...
                {availableSizes.map(size => {
                  ...
                  return (
                    <button
                      ...
                      data-guide-anchor="printSoleLabel.tamanhoToggle"
        ...
        <div className="flex gap-3 mt-4">
          <button
            onClick={onClose}
            data-guide-anchor="printSoleLabel.cancelar"
          ...
          <button
            onClick={handlePrint}
            data-guide-anchor="printSoleLabel.gerar"
