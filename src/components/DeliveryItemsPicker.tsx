    ...
    <Modal isOpen={isOpen} onClose={onClose} title={title} icon={<ListChecks size={20} />} maxWidth="max-w-lg" closeLabel="Cancelar">
      <div className="flex flex-col gap-3">
        ...
        <button
          ...
          data-guide-anchor="deliveryItemsPicker.selecionarTudo"
              ...
              >
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <button
                    ...
                    data-guide-anchor="deliveryItemsPicker.diminuirQtd"
                  ...
                  <button
                    ...
                    disabled={available === 0}
                    onClick={() => setQty(key, qty + 1, available)}
                    data-guide-anchor="deliveryItemsPicker.aumentarQtd"
                    className={`w-8 h-8 rounded-lg flex items-center justify-center font-black text-base transition-all active:scale-95 disabled:opacity-40 ${isDarkMode ? 'bg-slate-800 text-slate-300' : 'bg-slate-100 text-slate-600'}`}
                  >
                    +
                  </button>
        ...
        <div className="flex items-center gap-2">
          {selectedCount > 0 && (
            <button
              type="button"
              onClick={clearAll}
              data-guide-anchor="deliveryItemsPicker.limpar"
          ...
          <button
            type="button"
            onClick={handleSave}
            data-guide-anchor="deliveryItemsPicker.salvar"
