    ...
    return (
      <div key={idx} className="flex items-center justify-between gap-2 p-2 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700/50">
        <div className="flex items-center gap-2 min-w-0">
          ...
          {vari && (
            <>
              <span className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 shrink-0">•</span>
    ...
    return (
      <div key={idx} className="flex flex-col gap-2 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700/50">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">•</span>
        ...
        <div className="flex items-center justify-between pt-1 border-t border-slate-100 dark:border-slate-700">
          <span className="text-[11px] font-black text-slate-900 dark:text-white">{totalPairs} <span className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">pares</span></span>
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="text-left min-w-0">
            ...
            <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-1">Receitas, Despesas e Comparativos</p>
          </div>
        </div>
      ...
      <AnimatePresence initial={false}>
        {isOverviewExpanded && (
          ...
          >
            ...
            <div>
              <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">Lucro real agora</p>
              ...
              {businessOverview.comparison && (
                <div className="mt-2">
                  <div className="flex justify-between text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mb-1">
              ...
              <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-2 leading-relaxed">
              ...
              <div className="flex gap-3 mt-4">
                <div className="flex-1 p-3 rounded-2xl bg-slate-50 dark:bg-slate-950/50">
                  <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">Margem s/ receita</p>
                ...
                <button type="button" onClick={() => setShowExpenseBreakdown(true)} data-guide-anchor="dash.overview.despesasDetalhe" className="flex-1 p-3 rounded-2xl bg-slate-50 dark:bg-slate-950/50 text-left">
                  <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 flex items-center gap-1">
                    Despesas do período
              ...
              <div className="mt-4">
                <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mb-2">Receitas Totais × Despesas do Período</p>
                <div className="flex flex-col gap-2.5">
                  ...
                  <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 leading-relaxed">Lucro Real = Receitas Totais (todas as transações confirmadas no período) − Despesas do período.</p>
                </div>
              </div>
            ...
            <div className={`rounded-3xl border overflow-hidden ${isDarkMode ? 'border-slate-800 bg-slate-950/40' : 'border-slate-100 bg-slate-50/60'}`}>
              ...
              >
                <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">Resumo Financeiro</p>
                  ...
                  >
                    <div className="flex flex-col gap-2 px-3 pb-3.5">
                      ...
                      >
                        ...
                        <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-1 leading-relaxed">{accountsDesc} (contas de uso Pessoal não entram).</p>
                      </button>

                      <div className={`p-3 rounded-2xl ${isDarkMode ? 'bg-slate-900' : 'bg-white'}`}>
                        <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 flex items-center gap-1"><DollarSign size={10} /> A Receber (Pendente)</p>
                        ...
                        <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-1 leading-relaxed">Vendas já fechadas (não orçamento, não cancelada) que ainda não foram pagas por completo: total do pedido menos o que já foi pago.</p>
                      </div>

                      <div className={`p-3 rounded-2xl ${isDarkMode ? 'bg-slate-900' : 'bg-white'}`}>
                        <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 flex items-center gap-1"><TrendingUp size={10} /> Balanço do Mês (Liquidados)</p>
                        ...
                        <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-1 leading-relaxed">Receitas menos despesas já confirmadas (liquidadas) desde o dia 1º deste mês até agora — sempre o mês calendário atual, independente do período escolhido acima.</p>
                      </div>

                      <div className={`p-3 rounded-2xl ${isDarkMode ? 'bg-slate-900' : 'bg-white'}`}>
                        <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 flex items-center gap-1"><Boxes size={10} /> Patrimônio em Estoque</p>
                        ...
                        <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-1 leading-relaxed">Custo e valor de venda de tudo que está pronto no estoque agora, pelo preço de custo/venda cadastrado em cada modelo × quantidade em estoque.</p>
                      </div>

                      <div className={`p-3 rounded-2xl ${isDarkMode ? 'bg-slate-900' : 'bg-white'}`}>
                        <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 flex items-center gap-1"><Footprints size={10} /> Lucro por Par</p>
                        ...
                        <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-0.5 leading-relaxed">Mesmo cálculo do card "Análise de Lucro": (Receitas − Despesas) ÷ {businessOverview.producedPairs} {businessOverview.producedPairs === 1 ? 'par produzido' : 'pares produzidos'} — pelo mesmo período (Mês/Trimestre/Semestre/Ano) escolhido no seletor acima.</p>
                        <div className={`mt-2 pt-2 border-t ${isDarkMode ? 'border-slate-800' : 'border-slate-100'}`}>
                          <p className={`text-[11px] font-black ${isDarkMode ? 'text-slate-200' : 'text-slate-700'} ${hidePrivacy ? PRIVACY_BLUR_CLASS : ''}`}>
                            ...
                            <span className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 ml-1">Preço Médio de Venda (todos os modelos)</span>
                          </p>
                          <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-0.5 leading-relaxed">Receita das vendas fechadas ÷ {businessOverview.totalPairsSold} {businessOverview.totalPairsSold === 1 ? 'par vendido' : 'pares vendidos'} no período — média de todos os modelos, não os pares produzidos. Atacado conta os pares reais (não a caixa) usando o preço por par cadastrado no item.</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
            ...
            <div className="flex flex-col gap-2">
              <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 px-1">Base do Lucro Real</p>
              <button
                type="button"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">Soma de toda entrada confirmada em Financeiro no período — venda ou não. Único valor usado no Lucro Real.</p>
                </div>
              ...
              <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 px-1 mt-2">Outras Métricas (Informativo — não entram no Lucro Real)</p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">{s.desc}</p>
                    </div>
            ...
            <div className="flex flex-col gap-2">
              <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 px-1">Receita − Despesas — últimos 6 meses</p>
            ...
            <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 leading-relaxed px-1">
          ...
          >
            <div className="flex items-center justify-between p-6 pb-4 border-b border-slate-100 dark:border-slate-800">
              <div>
                ...
                <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-0.5">Escolha quais contas somam em "Saldos em Conta"</p>
              </div>
            ...
            <div className="flex flex-col gap-2 p-6">
              {businessAccounts.length === 0 && (
                <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 text-center py-6">Nenhuma conta do negócio cadastrada.</p>
              )}
            ...
            <div className="flex items-center justify-between p-6 pb-4 border-b border-slate-100 dark:border-slate-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-0.5">Compras "Não Contábil" que geraram título por engano</p>
                </div>
              </div>
                ...
                return (
                  <div key={t.id} className={`flex items-center gap-3 p-3 rounded-2xl ${isDarkMode ? 'bg-slate-800/50' : 'bg-slate-50'}`}>
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">{format(t.date, 'dd/MM/yyyy')} · {purchase?.type === PurchaseType.SOLE ? 'Solados' : 'Palmilhas'}</p>
                    </div>
          ...
          >
            <div className="flex items-center justify-between p-6 pb-4 border-b border-slate-100 dark:border-slate-800">
              <div>
                ...
                <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-0.5">{periodExpenseBreakdown.items.length} lançamento(s) — {OVERVIEW_PERIOD_LABELS[overviewConfig.periodType]} atual</p>
              </div>
            ...
            <div className="flex gap-3 px-6 pt-4">
              <div className="flex-1 p-3 rounded-2xl bg-slate-50 dark:bg-slate-950/50">
                <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">Vinculadas a compras</p>
              ...
              <div className="flex-1 p-3 rounded-2xl bg-slate-50 dark:bg-slate-950/50">
                <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">Outros lançamentos</p>
            ...
            <div className="flex flex-col gap-2 p-6">
              {periodExpenseBreakdown.items.length === 0 && (
                <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 text-center py-6">Nenhuma despesa nesse período.</p>
              )}
          ...
          >
            <div className="flex items-center justify-between p-6 pb-4 border-b border-slate-100 dark:border-slate-800">
              <div>
                ...
                <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-0.5">{periodIncomeBreakdown.items.length} lançamento(s) — {OVERVIEW_PERIOD_LABELS[overviewConfig.periodType]} atual</p>
              </div>
            ...
            <div className="flex gap-3 px-6 pt-4">
              <div className="flex-1 p-3 rounded-2xl bg-slate-50 dark:bg-slate-950/50">
                <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">Vinculadas a venda</p>
            ...
            <div className="flex flex-col gap-2 p-6">
              {periodIncomeBreakdown.items.length === 0 && (
                <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 text-center py-6">Nenhuma receita nesse período.</p>
              )}
        ...
        <div className="fixed inset-0 z-[65010] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={() => setSelectedPurchaseForCart(null)}>
          ...
          >
            <div className="flex justify-between items-center mb-4 shrink-0">
              <div>
                ...
                {(() => {
                  ...
                  return (
                    <p className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300 mt-0.5">
            ...
            <div className="flex items-center justify-between gap-2 pt-4 mt-4 border-t border-slate-100 dark:border-slate-800 shrink-0">
              <span className="text-[10px] font-medium tracking-wide text-blue-950 dark:text-blue-300">Total</span>
