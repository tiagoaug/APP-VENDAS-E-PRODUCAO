    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className={`w-full max-w-lg rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] ${isDarkMode ? 'bg-slate-900 border border-slate-800' : 'bg-white'}`}>
        ...
        <div className="p-6 flex items-center justify-between border-b border-slate-50 dark:border-slate-800">
          ...
          <button type="button" onClick={onClose} data-guide-anchor="salePayment.fechar" title="Fechar" aria-label="Fechar" className="w-10 h-10 rounded-full flex items-center justify-center bg-slate-50 dark:bg-slate-800 text-slate-400">
            <X size={20} />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 no-scrollbar">
          ...
          <div className="flex p-1 bg-slate-50 dark:bg-slate-950 rounded-2xl">
            <button
              ...
              data-guide-anchor="salePayment.abaHistorico"
            ...
            <button
              ...
              data-guide-anchor="salePayment.abaReceber"
              ...
              <div className={`rounded-3xl border shadow-md overflow-hidden ${isDarkMode ? 'bg-gradient-to-br from-slate-800 to-slate-900 border-slate-700/60 shadow-black/20' : 'bg-gradient-to-br from-white to-slate-50 border-slate-200/60 shadow-slate-200/50'}`}>
                ...
                {remaining > 0 && (
                  <button
                    ...
                    data-guide-anchor="salePayment.quitarTudo"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      data-guide-anchor="salePayment.abrirCalculadora"
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  {sale.paymentHistory && sale.paymentHistory.length > 0 && (
                    <button
                      ...
                      data-guide-anchor="salePayment.copiarHistorico"
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-1">
                    {onUpdatePayment && (
                      <button
                        onClick={() => startEdit(p)}
                        data-guide-anchor="salePayment.editarRecebimento"
                    ...
                    {onDeletePayment && (
                      <button
                        ...
                        data-guide-anchor="salePayment.excluirRecebimento"
                    ...
                    {confirmDeleteId === p.id && (
                       <button
                         ...
                         data-guide-anchor="salePayment.cancelarExclusao"
