    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className={`relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-[2.5rem] shadow-2xl animate-in zoom-in-95 duration-300 ${
        ...
        <div className="sticky top-0 z-20 flex items-center justify-between p-6 border-b border-slate-100 dark:border-slate-800 bg-inherit rounded-t-[2.5rem]">
          ...
          <button
            onClick={onClose}
            data-guide-anchor="palmilhaPurchaseModal.fechar"
            title="Fechar Modal"
        ...
        <div className="p-6 space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div className={`flex p-1 rounded-2xl border-2 ${isDarkMode ? 'bg-slate-950 border-slate-800' : 'bg-slate-50 border-slate-100'}`}>
                <button
                  ...
                  data-guide-anchor="palmilhaPurchaseModal.contabilToggle"
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  data-guide-anchor="palmilhaPurchaseModal.loteAutoToggle"
            ...
            <div className="space-y-2">
              ...
              <div className={`flex p-1 rounded-2xl border-2 ${isDarkMode ? 'bg-slate-950 border-slate-800' : 'bg-slate-50 border-slate-100'}`}>
                <button
                  ...
                  data-guide-anchor="palmilhaPurchaseModal.pagamentoToggle"
                  className={`flex-1 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
          ...
          <div className="space-y-4 pt-6 border-t border-slate-100 dark:border-slate-800">
            <div className="flex justify-between items-center">
              ...
              <button
                onClick={addItem}
                data-guide-anchor="palmilhaPurchaseModal.itemAdicionar"
                    ...
                    <div className="flex flex-col gap-3 mb-4">
                      ...
                      <div className="flex items-end gap-3">
                        ...
                        <button
                          ...
                          data-guide-anchor="palmilhaPurchaseModal.itemRemover"
                          title="Remover Item"
          ...
          <div className="space-y-6 pt-6 border-t border-slate-100 dark:border-slate-800">
            ...
            <button
              onClick={handleSave}
              data-guide-anchor="palmilhaPurchaseModal.confirmar"
