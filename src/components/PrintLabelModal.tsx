      ...
      <div className="flex flex-col gap-6 py-4">
        ...
        <div className="flex p-1 bg-slate-100 dark:bg-slate-800 rounded-2xl">
           <button
             ...
             data-guide-anchor="printLabelModal.abaImpressao"
           ...
           <button
             ...
             data-guide-anchor="printLabelModal.abaAjustarLayout"
             className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  data-guide-anchor="printLabelModal.modoPorTamanho"
                ...
                <button
                  ...
                  data-guide-anchor="printLabelModal.modoEtiquetaCaixa"
                  className={`flex-1 py-3 px-4 rounded-xl border-2 font-black text-[10px] uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${
                    isBoxLabel
                      ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400' 
                      : 'border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-400'
              ...
              <div className="flex gap-2">
                <button
                  ...
                  data-guide-anchor="printLabelModal.apenasUm"
                  className={`flex-1 py-3 px-4 rounded-xl border-2 font-black text-[10px] uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${
                    !useStockQuantities
                      ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400' 
                      : 'border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-400'
                ...
                <button
                  ...
                  data-guide-anchor="printLabelModal.qtdEmEstoque"
                  className={`flex-1 py-3 px-4 rounded-xl border-2 font-black text-[10px] uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${
                    useStockQuantities
                      ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400' 
                      : 'border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-400'
                ...
                <div className="flex flex-wrap gap-2">
                  {['30x20', '40x25', '40x30', '40x40', '50x25', '50x30', '50x40', '50x50'].map(size => (
                    <button
                      ...
                      data-guide-anchor="printLabelModal.selecionarTamanhoEtiqueta"
              ...
              <div className="grid grid-cols-2 gap-2">
                {product.variations.map(v => (
                  <button
                    ...
                    data-guide-anchor="printLabelModal.selecionarVariacao"
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between px-1">
                  ...
                  <button
                    ...
                    data-guide-anchor="printLabelModal.selecionarTodosTamanhos"
                  ...
                  {availableSizes.map(size => {
                    ...
                    return (
                      <button
                        ...
                        data-guide-anchor="printLabelModal.alternarTamanho"
        ...
        <div className="flex gap-3 mt-4">
          <button
            onClick={onClose}
            data-guide-anchor="printLabelModal.cancelar"
          ...
          <button
            onClick={handlePrint}
            data-guide-anchor="printLabelModal.gerarEtiquetas"
