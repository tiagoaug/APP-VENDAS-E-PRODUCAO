    ...
    <div className="flex flex-col gap-6 pb-32">
      <header className="flex items-center justify-between px-2">
        <div className="flex items-center gap-4">
          <button onClick={onBack} data-guide-anchor="categoryConfig.voltar" className="p-3 rounded-2xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 active:scale-95 transition-transform">
            <ArrowLeft size={20} />
          </button>
          <div>
            ...
            <div key={parent.id} className={`rounded-[2rem] border overflow-hidden transition-all ${isDarkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-100 shadow-xl shadow-slate-200/40'}`}>
              <div className="p-5 flex items-center justify-between bg-slate-50/50 dark:bg-slate-950/20 border-b dark:border-slate-800/50">
                ...
                <button
                  ...
                  data-guide-anchor="categoryConfig.abrirModulo"
          ...
          {(['sales', 'production', 'personal', 'any'] as const).map(m => {
            ...
            return (
              <button
                ...
                data-guide-anchor="categoryConfig.selecionarModulo"
