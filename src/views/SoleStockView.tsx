  ...
  return (
    <div className="flex flex-col h-full pb-44 px-1 overflow-y-auto overflow-x-hidden force-scrollbar">
      ...
      {/* bottom-36 + left-24/right-24 (não mais bottom-24 left-4/right-4) — mesmo ajuste
          feito em Vendas/Compras: a barra de navegação cresceu (grade 2 linhas + cards
          maiores de Home/Mais + seta de paginação perto do Mais) e bottom-24 full-width
      ...
      {isFormularPedidoMode && (
        <div className="fixed bottom-40 left-24 right-24 z-50">
          ...
          >
            <ShoppingCart size={18} /> Fazer a Compra
          </button>
        </div>
      )}
      ...
      {isBalanceMode && (
        <div className="fixed bottom-40 left-24 right-24 z-50">
          <button
            ...
            className="w-full py-3 rounded-2xl bg-indigo-600 text-white font-black uppercase tracking-widest text-xs shadow-2xl shadow-indigo-500/40 flex items-center justify-center gap-2 hover:bg-indigo-700 active:scale-95 transition-all"
          >
