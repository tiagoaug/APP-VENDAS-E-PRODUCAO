...
export default function ProductsView({
  ...
  // Segunda camada de proteção contra exclusão acidental — só libera o botão "Excluir" depois
  // de digitar "DELETAR" (case-insensitive), já que excluir um produto perde todas as variações
        ...
        <div className="fixed inset-0 z-[100] flex animate-in fade-in duration-300">
          ...
          <div className="relative m-auto w-[90%] max-w-sm bg-white dark:bg-slate-900 rounded-[2rem] p-6 shadow-2xl">
            ...
            <input
              ...
              placeholder="DELETAR"
              data-guide-anchor="products.confirmarExclusaoDigitar"
              autoFocus
            ...
            <div className="flex gap-3">
              <button
                onClick={() => { setItemToDelete(null); setDeleteConfirmText(""); }}
                data-guide-anchor="products.cancelarExclusao"
              ...
              <button
                ...
                data-guide-anchor="products.confirmarExclusao"
  ...
  return (
    ...
    >
      ...
      <button
        ...
        data-guide-anchor="products.expandirCard"
      ...
      {isExpanded && (
        <div className={`mx-4 mt-0.5 flex items-center gap-2 pb-3 border-b ${isDarkMode ? 'border-slate-800' : 'border-slate-100'}`}>
          <button
            type="button"
            onClick={onDuplicate}
            data-guide-anchor="products.duplicar"
          ...
          <button
            type="button"
            onClick={onEdit}
            data-guide-anchor="products.editar"
          ...
          <button
            type="button"
            onClick={onDelete}
            data-guide-anchor="products.excluir"
      ...
      <div className="px-4 py-2.5 flex gap-2 items-center flex-wrap">
        ...
        <button
          ...
          data-guide-anchor="products.alternarStatus"
